...
from honeybash.core.base_honeypot import BaseServer
...
class BaseHttpServer(BaseServer, ABC):
    """Base HTTP Honeypot for HoneyBash framework."""
...
# Aliases for HoneyBash architecture
BaseHTTPHoneypot = BaseHttpServer
QBaseHTTPServer = BaseHttpServer
